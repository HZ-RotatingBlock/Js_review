                ...
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{'check':item.checked==='1'}" @click="editCart('checked',item)">
                      ...
                      <img src="../../static/cartSuccess.png" style="margin-top:-1px;margin-left:-1px;width:21px;height:21px;" v-if="item.checked==='1'"/>
                    </a>
                  </div>
          ...
          <div class="cart-foot-inner">
              ...
              <div class="item-all-check">
                <a href="javascipt:;" @click="toggleCheckAll">
                  <span class="checkbox-btn item-check-btn" :class="{'check':checkAllFlag}">
                      <img src="../../static/cartSuccess.png" style="margin-bottom:20px;margin-left:-1px;width:21px;height:21px;" v-if="checkAllFlag"/>
                  </span>
                  <span>选择所有</span>
                </a>
              </div>
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                商品合计: <span class="total-price">{{totalPrice | currency('￥')}}</span>
              </div>
              <div class="btn-wrap">
...
<script>
    ...
    export default{
      ...
      computed: {
        // 判断商品是否已被全选
        // 计算属性是实时属性计算的，它是不能在除计算属性设置之外再次被赋值的，只能在这里再次赋值
        checkAllFlag () {
      ...
      methods: {
        ...
        editCart (flag, item) {
          if (flag === 'add') {
            ...
            item.productNum > 1 ? (item.productNum--) : (item.productNum = 1)
          } else {
